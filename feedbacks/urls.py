...
from feedbacks.views import FeedbackListAPIView, FeedbackCreateAPIView, MyFeedbackListAPIView, FeedbackRetrieveAPIView, \
    FeedbackUpdateAPIView, FeedbackDestroyAPIView
...
urlpatterns = [
                  ...
                  path('<int:pk>/', FeedbackRetrieveAPIView.as_view(), name='feedback_get'),
